!(function (e) {
  ...
  function t(e, i, a) {
    ...
    return (
      ...
      "string" == typeof e
        ...
        ? (o = n._objectURL = t.createObjectURL(e))
          ? ((n.src = o), n)
  ...
  var a =
    (e.createObjectURL && e) ||
    (e.URL && URL.revokeObjectURL && URL) ||
    (e.webkitURL && webkitURL);
  (t.fetchBlob = function (e, t, i) {
    ...
    (t.readFile = function (t, i, a) {
      if (e.FileReader) {
        ...
        if (((o.onload = o.onerror = i), (a = a || "readAsDataURL"), o[a]))
          return o[a](t), o;
      }
      return !1;
    }),
  ...
  (function (e) {
    ...
    (e.transform = function (i, a, o, n, r) {
      ...
      (e.scale = function (t, i, a) {
        ...
        if (
          (b &&
            ((f = (i = e.getTransformedOptions(t, i, a)).left || 0),
            (g = i.top || 0),
            i.sourceWidth
              ? ((d = i.sourceWidth),
                void 0 !== i.right &&
          ...
          b && r && s && i.crop
            ? ((I = r),
              ...
              (h = d / u - r / s) < 0
                ? ((u = (s * d) / r),
                  void 0 === i.top && void 0 === i.bottom && (g = (x - u) / 2))
                : h > 0 &&
                  ((d = (r * u) / s),
                  void 0 === i.left && void 0 === i.right && (f = (y - d) / 2)))
            : ((i.contain || i.cover) && ((l = r = r || l), (c = s = s || c)),
              i.cover ? (n(), o()) : (o(), n())),
          b)
        ) {
          if (
            ((p = i.pixelRatio) > 1 &&
              ...
              (I *= p),
              (v *= p),
              S.getContext("2d").scale(p, p)),
            (m = i.downsamplingRatio) > 0 && m < 1 && I < d && v < u)
          )
            for (; d * m > I; )
              (S.width = d * m),
                (S.height = u * m),
                ...
                (d = S.width),
                (u = S.height),
                ((t = document.createElement("canvas")).width = d),
                (t.height = u),
                e.renderImageToCanvas(t, S, 0, 0, d, u, 0, 0, d, u);
          return (
            (S.width = I),
            (S.height = v),
            e.transformCoordinates(S, i),
            e.renderImageToCanvas(S, t, f, g, d, u, 0, 0, I, v)
          );
        }
                ...
                for (
                  ...
                  if ((l = e.metaDataParsers.jpeg[r]))
                    for (c = 0; c < l.length; c += 1)
                      l[c].call(n, u, f, s, o, a);
                  p = f += s;
                }
                !a.disableImageHead &&
                  p > 6 &&
                  (d.slice
                    ? (o.imageHead = d.slice(0, p))
                    : (o.imageHead = new Uint8Array(d).subarray(0, p)));
  ...
  (function (e) {
    ...
    "undefined" != typeof fetch &&
      ...
      (e.fetchBlob = function (t, i, a) {
        if (e.hasMetaOption(a))
          return fetch(new Request(t, a))
            .then(function (e) {
              return e.blob();
            })
            .then(i)
    ...
    (e.hasCanvasOption = function (i) {
        ...
        if (c && !(c > 8))
          switch (
            ...
            case 5:
              ...
              break;
            case 6:
              o.rotate(0.5 * Math.PI), o.translate(0, -r);
              break;
            case 7:
              o.rotate(0.5 * Math.PI), o.translate(n, -r), o.scale(-1, 1);
              break;
            case 8:
              o.rotate(-0.5 * Math.PI), o.translate(-n, 0);
          }
      }),
      (e.getTransformedOptions = function (t, i, a) {
        var n,
          ...
          l = s.orientation;
        if (
          (!0 === l && a && a.exif && (l = a.exif.get("Orientation")),
          !l || l > 8 || 1 === l)
        )
          return s;
        n = {};
  ...
  (function (e) {
    ...
    (e.ExifMap = function () {
      ...
      (e.getExifThumbnail = function (t, i, a) {
        if (a && !(i + a > t.byteLength))
          return e.createObjectURL(new Blob([t.buffer.slice(i, i + a)]));
      ...
      (e.getExifValue = function (t, i, a, o, n, r) {
        ...
        if (g) {
          if (
            ((s = g.size * n),
            !(
              (l = s > 4 ? i + t.getUint32(a + 8, r) : a + 8) + s >
              t.byteLength
            ))
          ) {
            if (1 === n) return g.getValue(t, l, r);
            for (c = [], d = 0; d < n; d += 1)
              c[d] = g.getValue(t, l + d * g.size, r);
            if (g.ascii) {
              for (u = "", d = 0; d < c.length && "\0" !== (f = c[d]); d += 1)
                u += f;
              return u;
            }
            return c;
        ...
        if (!n.disableExif) {
          ...
          if (1165519206 === t.getUint32(i + 4))
            if (c + 8 > t.byteLength)
              ...
              42 === t.getUint16(c + 2, r)
                ? ((s = t.getUint32(c + 4, r)),
                  (o.exif = new e.ExifMap()),
                  (s = e.parseExifTags(t, c, c + s, r, o)) &&
                    !n.disableExifThumbnail &&
                    ((l = { exif: {} }),
                    (s = e.parseExifTags(t, c, c + s, r, l)),
                    l.exif[513] &&
                  ...
                  o.exif[34665] &&
                    !n.disableExifSub &&
                    e.parseExifTags(t, c, c + o.exif[34665], r, o),
                  o.exif[34853] &&
                    !n.disableExifGps &&
                    e.parseExifTags(t, c, c + o.exif[34853], r, o))
  ...
  (function (e) {
    ...
    (e.IptcMap = function () {
      ...
      (e.IptcMap.prototype.map = { ObjectName: 5 }),
      (e.IptcMap.prototype.get = function (e) {
        return this[e] || this[this.map[e]];
      }),
      (e.parseIptcTags = function (e, t, i, a) {
        for (var o, n, r = t; r < t + i; )
          28 === e.getUint8(r) &&
            2 === e.getUint8(r + 1) &&
            (n = e.getUint8(r + 2)) in a.iptc.tags &&
            ((o = (function (e, t, i) {
              for (var a = "", o = t; o < t + i; o++)
                a += String.fromCharCode(e.getUint8(o));
              return a;
            })(e, r + 5, e.getInt16(r + 3))),
            a.iptc.hasOwnProperty(n)
              ? a.iptc[n] instanceof Array
                ? a.iptc[n].push(o)
                : (a.iptc[n] = [a.iptc[n], o])
              : (a.iptc[n] = o)),
            r++;
